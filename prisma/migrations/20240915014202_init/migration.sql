...
CREATE TABLE `Notification` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `content` VARCHAR(191) NOT NULL,
    `type` ENUM('ANNOUNCEMENT', 'REMINDER', 'ALERT') NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `userId` INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Reservation` ADD CONSTRAINT `Reservation_areaCommonId_fkey` FOREIGN KEY (`areaCommonId`) REFERENCES `AreaCommon`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
